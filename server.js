...
// CORS configurado correctamente para GitHub Pages
...
app.options('*', cors(corsOptions)); // Responde preflight OPTIONS
...
const client = new Pool({ connectionString: PG_CONNECTION_STRING });
